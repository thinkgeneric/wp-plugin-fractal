...
abstract class Importer {
	...
	{
		add_action( 'wp_ajax_get_factual_data', array( $this, 'get_factual_data' ) );
		add_action( 'wp_ajax_import_factual_data', array( $this, 'import_factual_data' ) );
	}
